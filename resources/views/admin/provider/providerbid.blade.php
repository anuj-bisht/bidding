                    ...
                    <div class="card-body">
                       ...
                       <div class="table-responsive" style="font-size:12px;">
                          <table class="table">
                             ...
                             <tbody>
                                 @forelse($bids as $consignment)
                                <tr>
                                   <td>
                                      {{$loop->iteration}}
                                   </td>
                                   <td>
                                    {{$consignment->category_name}}
                                   </td>
                                   <td>
                                   ...
                                   <td>
                                    <a href="{{url('viewconsignment')}}/{{$consignment->bid_id}}"><i class="fa-solid fa-eye"></i></a>
                                   </td>
                                   {{-- <td>
