                               ...
                               <td>
                                ...
                                <td>
                                    @if(isset($provider->provider_id))
                                        <a href="{{ route('toggleProviderStatus', $provider->provider_id) }}">{{ $provider->is_active?'Active':'Inactive' }}</a>
                                    @else
                                        Inactive
                                    @endif
                                ...
                                <td>
                                <a class="" href="{{url('addCoins')}}/{{$provider->id}}"><i class="fa-solid fa-coins"></i></a>
                               </td>
                               <td>
                                <a href="{{url('viewproviderdetail')}}/{{$provider->id}}"><i class="fa-solid fa-eye"></i></a>
                               </td>
                               {{-- <td>
